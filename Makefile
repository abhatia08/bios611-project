...
# Note: this will create all univariate plots to stitch together into a final figure in pdf and png format

figures/fig_univariate_all: derived_data/plotting_data.csv scripts/util.R
		Rscript scripts/06_fig_univariate.R 

# Note: this will create all bivariate plots to stitch together into a final figure in pdf and png format

figures/fig_bivariate_retail: derived_data/plotting_data.csv scripts/util.R
		Rscript scripts/07_fig_bivariate_retail.R 

figures/fig_bivariate_api: derived_data/plotting_data.csv scripts/util.R
		Rscript scripts/08_fig_bivariate_api.R 

figures: derived_data/plotting_data.csv scripts/util.R figures/fig_univariate_all figures/fig_bivariate_retail figures/fig_bivariate_api
