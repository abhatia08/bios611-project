...
# Note: this will create all univariate plots to stitch together into a final figure in pdf and jpg format

figures/fig_univariate_all: derived_data/plotting_data.csv scripts/util.R
		Rscript scripts/06_fig_univariate.R 

# Note: this will create all bivariate plots to stitch together into a final figure in pdf and jpg format
